...
<body>
            ...
            <div class="modal-content">
                ...
                <form id="modal-delete-form" action="" method="post">
                    ...
                    <div class="modal-body">
                        <strong class="text-danger">Are you sure want to delete this post?</strong>                    
                    </div>
    ...
    <script type="text/javascript">
        ...
        var modalDeleteForm = document.getElementById('modal-delete-form');
        ...
        modalDeleteForm.addEventListener("submit", function( evt ) {
